...
Subset WRF output files for wind turbine case study runs, output at 10 min intervals
"""
...
def main(fdir, sdir, dm):
    files = sorted(glob.glob(fdir + f'/wrfout_{dm}*'))
    for fname in files:
        ...
        save_name = 'wrfproc_{}_{}_00Z_H{:03d}_M{:02d}.nc'.format(domain,
                                                                  splitter[2].replace('-', ''),
                                                                  int(splitter[-1].split(':')[0]),
                                                                  int(splitter[-1].split(':')[1]))
...
if __name__ == '__main__':
    file_dir = '/home/coolgroup/ru-wrf/real-time/v4.1_parallel/wrfout_windturbs/constdt/1km_ctrl/20220810'  # 1kmrun  1kmctrl
    save_dir = '/home/coolgroup/ru-wrf/real-time/v4.1_parallel/wrfout_windturbs/constdt/1km_ctrl/processed/20220810'
    dmain = 'd03'  # d01 = 9km, d02 = 3km, d03 = 1km
    main(file_dir, save_dir, dmain)
