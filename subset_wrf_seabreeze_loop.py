...
def main(fdir, sdir, dm):
    ...
    for fname in files:
        ...
        save_name = 'wrfproc_seabreeze_{}_{}_00Z_H{:03d}.nc'.format(domain,
                                                                    splitter[2].replace('-', ''),
                                                                    int(splitter[-1].split(':')[0]))

        save_file = os.path.join(sdir, domain, save_name)
...
if __name__ == '__main__':
    fdir = '/home/coolgroup/ru-wrf/real-time/v4.1_parallel/wrfout/20220801'
    sdir = '/home/lgarzio/rucool/bpu/wrf/seabreeze_202208'
    dm = 'd02'  # d01 = 9km, d02 = 3km
    main(fdir, sdir, dm)
